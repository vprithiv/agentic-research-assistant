...
| UNVERIFIABLE_ACCESS | Source exists but full text not accessible for verification | — (access flag) | Paywalled journal article (non-blocking; flagged for human review) |
...
- PASS_WITH_NOTES: Only MINOR_DISTORTION and/or UNVERIFIABLE_ACCESS (non-blocking)

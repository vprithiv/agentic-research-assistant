...
| **Medium** | `MEDIUM` | Individual paragraphs need rewriting | Individual paragraphs inadequately paraphrased (1-2 instances of `CLOSE_MATCH`); methodology description overly similar to prior work |
...
| 3 | MEDIUM | Self-plagiarism | §X.X, paragraph Y | Methodology description verbatim identical to prior work | Author (Year) | Rewrite and cite prior work |

...
- Generate 3-5 candidate research questions (interrogative form) OR research objectives (declarative form, for computational/modeling fields)
- For computational mechanics / materials science: frame as objectives (e.g., "Develop a validated FEM framework for...") rather than questions
- For other fields: vary question types — descriptive, comparative, correlational, causal, evaluative
- Each question/objective must be specific enough to suggest a methodology

...
If a Style Profile is available from a prior `paper-writing` intake or provided by the user:
...
Before finalizing the report, run the Writing Quality Check checklist (see `paper-writing/references/writing_quality_check.md`):

...
literature-review provides 7 modes suited to different research stages and needs. This guide helps users select the most appropriate mode.
...
socratic → paper-writing    Write paper directly after Socratic completion
...
systematic-review → paper-writing  Write up systematic review as a paper
```

### literature-review to paper-writing Mode Mapping

| literature-review Mode | Output | Maps to paper-writing Mode | Description |
|-------------------|------|--------------------------|------|
...
### literature-review vs peer-review Mode Mapping

| literature-review `review` mode | peer-review |
|------------------------------|------------------------|
...
```
Step 1: literature-review (socratic/full)
          ↓ Research Plan / Full Report
Step 2: paper-writing (plan/full)
          ↓ Paper draft
Step 3: peer-review (full/guided)
          ↓ Review comments
Step 4: paper-writing (revision)
          ↓ Revised paper
...
### Transition: systematic-review → paper-writing

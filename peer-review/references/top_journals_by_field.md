...
| Journal | Publisher | Impact Factor Range | Typical Review Preferences |
|---------|----------|-------------------|---------------------------|
| *Journal of the Mechanics and Physics of Solids (JMPS)* | Elsevier | 5-7 | Demands rigorous continuum mechanics theory with clear physical insight; analytical or semi-analytical solutions valued alongside numerics; experimental validation strongly preferred |
| *Computer Methods in Applied Mechanics and Engineering (CMAME)* | Elsevier | 6-8 | Expects convergence proofs or rigorous numerical analysis; novel formulations must demonstrate mathematical properties (stability, consistency); benchmark problems required |
| *International Journal of Plasticity (IJP)* | Elsevier | 9-10 | Requires experimental validation of constitutive models; microstructure-property linkage valued; parameter identification methodology must be transparent and reproducible |
| *International Journal for Numerical Methods in Engineering (IJNME)* | Wiley | 4-6 | Prioritizes novel numerical methods with rigorous error analysis; convergence rates, stability proofs, and efficiency comparisons against existing methods expected |
| *Computational Mechanics* | Springer | 4-5 | Balances theory and computation; multiscale and multiphysics methods welcomed; clear demonstration of method advantages over alternatives required |
| *Computational Materials Science* | Elsevier | 3-4 | Accepts DFT, MD, phase-field, and continuum methods; requires connection to experimentally observable quantities; materials design and discovery applications valued |
| *Journal of Computational Physics (JCP)* | Elsevier | 4-5 | Emphasizes algorithmic innovation and computational efficiency; expects thorough verification against analytical solutions; scalability and performance benchmarks valued |
| *International Journal of Solids and Structures (IJSS)* | Elsevier | 3-4 | Covers analytical, numerical, and experimental solid mechanics; theoretical contributions should include validation; structural applications welcomed |
| *Mechanics of Materials* | Elsevier | 3-4 | Material behavior focus; constitutive modeling with experimental grounding; microstructure-informed models valued; clear connection between model and physical mechanisms expected |
| *Modelling and Simulation in Materials Science and Engineering* | IOP | 2-3 | Emphasizes multiscale modeling and simulation methodology; atomistic-to-continuum bridging; requires clear description of simulation protocols for reproducibility |
| *Acta Materialia* | Elsevier | 8-9 | Premier materials science journal; computational papers must provide significant materials insight beyond method development; experimental validation or collaboration strongly preferred |
| *Journal of Nuclear Materials* | Elsevier | 2-3 | Nuclear materials focus; irradiation damage, fuel performance, and structural materials modeling; regulatory relevance valued; long-term prediction capability important |
| *Nuclear Engineering and Design* | Elsevier | 2-3 | Engineering design and safety analysis of nuclear systems; reactor component modeling, thermal-hydraulics coupling, structural integrity; applied engineering focus over fundamental science; regulatory and licensing relevance valued |
| *Journal of Nuclear Engineering and Radiation Science (JNERS)* | ASME | 1-2 | ASME society journal; reactor engineering, radiation effects, fuel cycle analysis; practical engineering applications; conference-paper-to-journal pathway common |
| *Nuclear Materials and Energy* | Elsevier | 2-3 | Fusion and fission materials; plasma-material interaction, irradiation effects, advanced materials for nuclear systems; shorter format, rapid communication style |
| *npj Computational Materials* | Nature/Springer | 9-12 | High-impact computational materials; demands significant materials insight and broad impact; data-driven and ML approaches welcomed; open access; code/data availability expected; must go beyond incremental modeling improvements |
| *Nature Computational Science* | Nature/Springer | 12-15 | Highest impact for computational methods; must demonstrate transformative computational advance applicable beyond a single material system; accessibility to broad audience essential |
| *Materialia* | Elsevier (Acta family) | 3-4 | Sister journal to Acta Materialia; computational and experimental materials science; more accepting of methods-focused work than Acta; good venue for novel modeling approaches with initial validation |
| *Journal of the American Ceramic Society* | Wiley | 3-4 | Ceramic materials including UO₂, SiC, graphite; experimental and computational; strong tradition in nuclear ceramics and oxide fuels; microstructure-property relationships |
| *Carbon* | Elsevier | 10-11 | Premier journal for carbon materials (graphite, graphene, carbon composites); experimental emphasis but computational work accepted if providing significant physical insight; high impact factor demands strong novelty |
| *International Journal of Fracture* | Springer | 2-3 | Fracture and failure mechanics; analytical, computational (XFEM, phase-field, cohesive zone), and experimental approaches; crack path prediction and validation against experiments expected |

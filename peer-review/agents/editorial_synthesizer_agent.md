...
6. Ensure the Revision Roadmap format is directly compatible with `paper-writing` revision mode input
...
Thank you for submitting your manuscript titled "[Paper Title]" to [Journal Name]. Your manuscript has been assessed from [N] analytical perspectives, including the Editor-in-Chief.
...
- [ ] Revision Roadmap format is compatible with `paper-writing` revision mode input format

...
**Key differences from the literature-review version**:
- literature-review's Socratic Mentor is a "journal editor-in-chief" — focused on the research question itself
- paper-writing's Socratic Mentor is a "thesis advisor" — focused on how to write the paper well
...
| Has nothing | Insufficient research foundation | Recommend running `literature-review` (socratic mode) first |

### Deep Research Referral Template

```
I notice you don't yet have a clear research question or literature foundation.
I recommend using literature-review (socratic mode) first to:

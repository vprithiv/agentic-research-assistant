...
| 2 | Wrong author format | Non-Western author name order inconsistency | Yes (verify correct name order per style guide) |
...
| S4, P1 | According to Smith, 2024's study | According to Smith (2024) | APA 7th: narrative citation uses parenthesized year |
```
...
└── Mixed format conflict ->
    Handling: Unify per selected citation style guide
```
...
| Multilingual sources | Verify non-English source formatting per style guide (e.g., translated titles, romanization) |
